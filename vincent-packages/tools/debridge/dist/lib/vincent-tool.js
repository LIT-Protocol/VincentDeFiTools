...
import { DEBRIDGE_CONTRACTS, validateChainId, validateAddress, getTokenBalance, getTokenDecimals, checkAndApproveToken, isNativeToken, callDeBridgeAPI, getRpcUrl, } from "./helpers";
export const vincentTool = createVincentTool({
    ...
    execute: async ({ toolParams }, { succeed, fail, delegation }) => {
        ...
        try {
            ...
            console.log(`${logPrefix} Parsed gas params response:`, parsedGasParamsResponse);
            ...
            const txHash = await laUtils.transaction.primitive.sendTx(provider, signedTx);
